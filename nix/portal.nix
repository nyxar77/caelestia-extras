...
in {
  ...
  xdg.configFile."caelestia/templates/qbittorrent.json".text = ''
    { "colors": {
      ...
      "Log.TimeStamp": "#{{ onSurfaceVariant.hex }}", "Log.Normal": "#{{ onSurface.hex }}", "Log.Info": "#{{ primary.hex }}", "Log.Warning": "#{{ secondary.hex }}", "Log.Critical": "#{{ error.hex }}", "Log.BannedPeer": "#{{ error.hex }}",
